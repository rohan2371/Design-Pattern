...
import LowLevelDesignQuestions.LLDBookMyShow.Enums.SeatCategory;
...
public class BookMyShow {
    ...
    private void createTheatre() {
        ...
        Show inoxEveningShow = createShows(2, inoxTheatre.getScreens().get(0), baahubaliMovie, 16);
        ...
        Show pvrEveningShow = createShows(4, pvrTheatre.getScreens().get(0), baahubaliMovie, 20);
